                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <div class="row">
                                            <div class=".col-sm-6">
                                                <?php
                                                    echo '<img src="'.$_SESSION["user_image"].'" class="img-responsive img-circle img-thumbnail" style="padding: .25rem;
                                                    background-color: #fff;max-width: 11%;
                                                    height: auto;" />';
                                                ?> 
                                            </div>
                                            <div class=".col-sm-6">
                                            <?php
                                            echo '<p>Hello &nbsp; <strong>'.$_SESSION['user_first_name'].'&nbsp;</strong><br>If Not&nbsp;<strong>'.$_SESSION['user_first_name'].'!</strong>&nbsp;<a href=logout.php">Logout</a>';
                                        ?>
                                            </div>
                                        </div>
